"""Option H: Plain default=Any with NO subclass __new__, NO __init__ overloads.

This is the 'naive' default=Any to see exactly where each checker fails.
"""
...
book.subtitle = None
book.edition = None
book.isbn = None  # expect: error (explicit null=False)

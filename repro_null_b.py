"""Option B: overload __init__ to bind _NT definitively. Bare annotations stay Any."""
...
class Field(Generic[_ST, _GT, _NT]):
    @overload
    def __init__(self: Field[_ST, _GT, Literal[False]], *, null: Literal[False] = False, **kwargs: Any) -> None: ...
    @overload
    def __init__(self: Field[_ST, _GT, Literal[True]], *, null: Literal[True], **kwargs: Any) -> None: ...
...
class CharField(Field[_ST_Char, _GT_Char, _NT]):
    @overload
    def __init__(
        self: CharField[_ST_Char, _GT_Char, Literal[False]],
        *,
    ...
    @overload
    def __init__(
        self: CharField[_ST_Char, _GT_Char, Literal[True]],
        *,
        max_length: int | None = None,
        null: Literal[True],
        **kwargs: Any,
...
class IntegerField(Field[_ST_Int, _GT_Int, _NT]):
    @overload
    def __init__(
        self: IntegerField[_ST_Int, _GT_Int, Literal[False]],
        *,
        null: Literal[False] = False,
        **kwargs: Any,
    ) -> None: ...
    @overload
    def __init__(
        self: IntegerField[_ST_Int, _GT_Int, Literal[True]],
        *,
        null: Literal[True],
        **kwargs: Any,
    ) -> None: ...

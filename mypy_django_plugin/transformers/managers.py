...
def reparametrize_any_class_hook(ctx: ClassDefContext, base_class_fullname: str) -> None:
    """
...
def reparametrize_any_manager_hook(ctx: ClassDefContext) -> None:
    ...
    """
    reparametrize_any_class_hook(ctx, fullnames.BASE_MANAGER_CLASS_FULLNAME)
...
def reparametrize_any_queryset_hook(ctx: ClassDefContext) -> None:
    ...
    """
    reparametrize_any_class_hook(ctx, fullnames.QUERYSET_CLASS_FULLNAME)

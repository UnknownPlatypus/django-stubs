...
class Manager(BaseManager[_T, _QS]):
    # NOTE: The following methods are in common with QuerySet. Methods that proxy to `get_queryset()` and
    # preserve its type return `_QS`; methods building a differently-typed queryset (e.g. `values`,
    # `datetimes`, `extra`) return a plain `QuerySet` instead.
    ...
    def union(self, *other_qs: QuerySet[Model, Any], all: bool = ...) -> _QS: ...
    def intersection(self, *other_qs: QuerySet[Model, Any]) -> _QS: ...
    def difference(self, *other_qs: QuerySet[Model, Any]) -> _QS: ...
    ...
    @overload
    def prefetch_related(self, clear: None, /) -> _QS: ...
    @overload
    def prefetch_related(self, *lookups: str | Prefetch[_LookupT, _PrefetchedQuerySetT, _ToAttrT]) -> _QS: ...
    def annotate(self, *args: Any, **kwargs: Any) -> _QS: ...
    def alias(self, *args: Any, **kwargs: Any) -> _QS: ...
    def order_by(self, *field_names: str | Combinable) -> _QS: ...
    def distinct(self, *field_names: str) -> _QS: ...

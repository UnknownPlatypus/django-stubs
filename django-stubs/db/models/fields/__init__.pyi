...
class Field(RegisterLookupMixin, Generic[_ST, _GT]):
    ...
    concrete: bool
    default: Any
    error_messages: _ErrorMessagesDict  # TODO: cached property
    ...
    def select_format(self, compiler, sql, params): ...  # TODO
    def deconstruct(self) -> tuple[str, str, Sequence[Any], dict[str, Any]]: ...
    def clone(self) -> Self: ...
    # TODO: __eq__ / __lt__ with total ordering ?
    ...
    def get_db_converters(self, connection: BaseDatabaseWrapper) -> list[Callable]: ...  # TODO
    @property
    def unique(self) -> bool: ...
    @property
    def db_tablespace(self) -> str | None: ...
    @property
    def db_returning(self) -> bool: ...
    def set_attributes_from_name(self, name: str) -> None: ...
    def contribute_to_class(self, cls: type[Model], name: str, private_only: bool = ...) -> None: ...
    def get_filter_kwargs_for_object(self, obj) -> dict[str, _GT]: ...

...
class ForeignObject(RelatedField[_ST, _GT, _NT]):
    ...
    @overload
    @override
    def __get__(self: ForeignObject[Any, _GT, Literal[False]], instance: Model, owner: Any) -> _GT: ...
    # nullable Model instance access
    @overload
    @override
    def __get__(self: ForeignObject[Any, _GT, Literal[True]], instance: Model, owner: Any) -> _GT | None: ...
    # non-Model instances
    @overload
    @override
...
class OneToOneField(ForeignKey[_ST, _GT, _NT]):
    ...
    @overload
    @override
    def __get__(self: OneToOneField[Any, _GT, Literal[False]], instance: Model, owner: Any) -> _GT: ...
    # nullable Model instance access
    @overload
    @override
    def __get__(self: OneToOneField[Any, _GT, Literal[True]], instance: Model, owner: Any) -> _GT | None: ...
    # non-Model instances
    @overload
    @override
    def __get__(self, instance: Any, owner: Any) -> Self: ...

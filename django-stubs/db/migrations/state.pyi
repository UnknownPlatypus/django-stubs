...
class ModelState:
    ...
    def get_field(self, field_name: str) -> Field[Any, Any]: ...
    @cached_property
...
class ProjectState:
    ...
    def add_field(
        self, app_label: str, model_name: str, name: str, field: Field[Any, Any], preserve_default: Any
    ) -> None: ...
    ...
    def resolve_model_field_relations(
        self, model_key: tuple[str, str], field_name: str, field: Field[Any, Any], concretes: Any | None = None
    ) -> None: ...

...
def setting_value_to_an_array_of_invalid_type_error() -> None:
    ...
    non_init.array = array_val3  # type: ignore[assignment] # pyright: ignore[reportAttributeAccessIssue] # ty:ignore[invalid-assignment] # pyrefly: ignore[bad-argument-type]


def setting_value_to_an_array_of_combinable_error() -> None:
    array_val4: list[F] = [F("id")]
    MyModel(array=array_val4)  # type: ignore[misc]
    non_init.array = array_val4  # type: ignore[assignment] # pyright: ignore[reportAttributeAccessIssue] # ty:ignore[invalid-assignment] # pyrefly: ignore[bad-argument-type]
